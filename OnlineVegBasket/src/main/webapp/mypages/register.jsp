...
<div class="signup-form">
    <form action="/adddata" method="post">
       ...
       <div class="form-group">
		...
		<div class="form-group">
            <input type="text" class="form-control" name="mobile" placeholder="Enter your mobile number" required="required">
        </div>    
        <div class="form-group">
		...
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-lg btn-block" onclick="validate()">Register Now</button>
        </div>
    </form>
</div>
<a href="/generalhome"><center>Registered User?Login</center></a>
</body>
</html>